...
class CurrencyAPI:
    """Client for `/v1/currency` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/currency
     - get(id) -> GET /v1/currency/{id}
     - create(payload) -> POST /v1/currency
     - update(id, payload) -> PUT /v1/currency/{id}
     - delete(id) -> DELETE /v1/currency/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/currency'
