...
class InvoiceAPI:
    """Client for `/v1/invoice` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/invoice
     - get(id) -> GET /v1/invoice/{id}
     - create(payload) -> POST /v1/invoice
     - update(id, payload) -> PUT /v1/invoice/{id}
     - delete(id) -> DELETE /v1/invoice/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/invoice'
