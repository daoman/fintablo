...
class AccountAPI:
    """Client for `/v1/account` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/account
     - get(id) -> GET /v1/account/{id}
     - create(payload) -> POST /v1/account
     - update(id, payload) -> PUT /v1/account/{id}
     - delete(id) -> DELETE /v1/account/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/account'
