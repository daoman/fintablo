...
class ProjectAPI:
    """Client for `/v1/project` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/project
     - get(id) -> GET /v1/project/{id}
     - create(payload) -> POST /v1/project
     - update(id, payload) -> PUT /v1/project/{id}
     - delete(id) -> DELETE /v1/project/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/project'
