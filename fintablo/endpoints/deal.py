...
class DealAPI:
    """Client for `/v1/deal` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/deal
     - get(id) -> GET /v1/deal/{id}
     - create(payload) -> POST /v1/deal
     - update(id, payload) -> PUT /v1/deal/{id}
     - delete(id) -> DELETE /v1/deal/{id}
    """
