...
class TransactionAPI:
    """Client for `/v1/transaction` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/transaction
     - get(id) -> GET /v1/transaction/{id}
     - create(payload) -> POST /v1/transaction
     - update(id, payload) -> PUT /v1/transaction/{id}
     - delete(id) -> DELETE /v1/transaction/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/transaction'
