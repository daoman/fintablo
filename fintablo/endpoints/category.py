...
class CategoryAPI:
    """Client for `/v1/category` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/category
     - get(id) -> GET /v1/category/{id}
     - create(payload) -> POST /v1/category
     - update(id, payload) -> PUT /v1/category/{id}
     - delete(id) -> DELETE /v1/category/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/category'
