...
class UserAPI:
    """Client for `/v1/user` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/user
     - get(id) -> GET /v1/user/{id}
     - create(payload) -> POST /v1/user
     - update(id, payload) -> PUT /v1/user/{id}
     - delete(id) -> DELETE /v1/user/{id}
    """
