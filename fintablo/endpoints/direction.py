...
class DirectionAPI:
    """Client for `/v1/direction` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/direction
     - get(id) -> GET /v1/direction/{id}
     - create(payload) -> POST /v1/direction
     - update(id, payload) -> PUT /v1/direction/{id}
     - delete(id) -> DELETE /v1/direction/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/direction'
