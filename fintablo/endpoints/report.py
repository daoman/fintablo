...
class ReportAPI:
    """Client for `/v1/report` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/report
     - get(id) -> GET /v1/report/{id}
     - create(payload) -> POST /v1/report
     - update(id, payload) -> PUT /v1/report/{id}
     - delete(id) -> DELETE /v1/report/{id}
    """
