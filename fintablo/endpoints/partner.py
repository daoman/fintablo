...
class PartnerAPI:
    """Client for `/v1/partner` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/partner
     - get(id) -> GET /v1/partner/{id}
     - create(payload) -> POST /v1/partner
     - update(id, payload) -> PUT /v1/partner/{id}
     - delete(id) -> DELETE /v1/partner/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/partner'
