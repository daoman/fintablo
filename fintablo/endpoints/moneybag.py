...
class MoneybagAPI:
    """Client for `/v1/moneybag` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/moneybag
     - get(id) -> GET /v1/moneybag/{id}
     - create(payload) -> POST /v1/moneybag
     - update(id, payload) -> PUT /v1/moneybag/{id}
     - delete(id) -> DELETE /v1/moneybag/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/moneybag'
