...
class BalanceAPI:
    """Client for `/v1/balance` endpoints (auto-generated simple wrapper).

    Methods:
     - list(params) -> GET /v1/balance
     - get(id) -> GET /v1/balance/{id}
     - create(payload) -> POST /v1/balance
     - update(id, payload) -> PUT /v1/balance/{id}
     - delete(id) -> DELETE /v1/balance/{id}
    """
    def __init__(self, client):
        self.client = client
        self.base = '/v1/balance'
